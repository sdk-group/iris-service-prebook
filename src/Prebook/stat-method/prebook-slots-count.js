module.exports = {
	...
	compute: function (datapart) {
		...
		return (datapart.forced_max_prebook_slots_count - datapart.forced_prebook_slots_count) || _.clamp(_.floor(_.sumBy(datapart.prebook_chunk_mapping, t => (_.floor(t / datapart.prebook_slot_size) - 1)) * part), 0, Infinity);
	}
