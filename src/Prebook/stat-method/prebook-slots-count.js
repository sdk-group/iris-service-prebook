module.exports = {
	...
	compute: function (datapart) {
		...
		return _.isNumber(datapart.forced_max_prebook_slots_count) ? val : _.clamp(_.floor(datapart.prebook_slots_count * part) - _.floor(datapart.offset / datapart.prebook_expiry), 0, Infinity);
	}
